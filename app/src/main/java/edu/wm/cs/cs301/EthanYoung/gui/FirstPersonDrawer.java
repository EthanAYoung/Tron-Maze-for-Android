...
public class FirstPersonDrawer {
	 ...
	 * @param bspRoot
	 */
	public FirstPersonDrawer(MazePanel p, int width, int height, int mapUnit, int stepSize, Cells seenCells, BSPNode bspRoot) {
	...
	public void draw(MazePanel panel2, int x, int y, int walkStep, int ang) {
        ...
        panel.drawHelper(viewWidth, viewHeight);
