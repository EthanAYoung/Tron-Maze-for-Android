...
public class Controller {
    ...
    public boolean keyDown(UserInput key, int value) {
    	...
    	if((key == Constants.UserInput.Left || key == Constants.UserInput.Right || key == Constants.UserInput.Up || key == Constants.UserInput.Down) && stateNum == 2) {
    		return driver.keyDown(key, value);
    	}
    	else {
