 ...
 * object and calling for {@link #computeDistances(Cells) computeDistances}
...
public class Distance {
	 ...
	 * by a subsequent call to {@link #computeDistances(Cells)} computeDistances.
	 ...
	 * only to go an adjacent position if there is no wall in 
	 ...
	 * @param cells with information on walls for a maze, can not be null, read only
	 ...
	 * @param cells with information on walls for a maze, can not be null
