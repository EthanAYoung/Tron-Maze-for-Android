...
public class BSPBuilder {
     ...
     */
    private edu.wm.cs.cs301.EthanYoung.generation.BSPNode genNodes(ArrayList<edu.wm.cs.cs301.EthanYoung.generation.Seg> sl) throws InterruptedException {
        ...
        if (countNonPartitions(sl) == 0)
            return new edu.wm.cs.cs301.EthanYoung.generation.BSPLeaf(sl);
